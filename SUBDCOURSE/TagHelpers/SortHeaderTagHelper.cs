...
namespace SUBDCOURSE.TagHelpers
{
    public class SortHeaderTagHelper : TagHelper
    {
        public SortKey Property { get; set; } // значение текущего свойства, для которого создается тег
        public SortKey Current { get; set; }  // значение активного свойства, выбранного для сортировки
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.TagName = "a";
            string url = urlHelper.Action(Action, new { sortKey = Property });
